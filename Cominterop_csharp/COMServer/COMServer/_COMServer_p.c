...
/* Object interface: IWelcome, ver. 0.0,
   GUID={0x015ED275,0x3DE6,0x4716,{0xA6,0xFA,0x4E,0xBC,0x71,0xE4,0xA8,0xEA}} */
...
/* Object interface: IMath, ver. 0.0,
   GUID={0x2158751B,0x896E,0x461d,{0x90,0x12,0xEF,0x16,0x80,0xBE,0x06,0x28}} */
...
int __stdcall __COMServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( __COMServer, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( __COMServer, 2, *pIndex )
